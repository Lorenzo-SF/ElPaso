defmodule ElPaso.CLI.Legacy do
  @moduledoc """
  ...
  @doc """
  Legacy hand-rolled dispatcher.  Preserved for backwards compatibility
  with internal tests that exercise specific argv patterns.

  Use `ElPaso.CLI.main/1` (DSL) for new code.
  """
  def legacy_dispatch(args) do
    main(args)
  end
