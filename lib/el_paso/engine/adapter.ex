defmodule ElPaso.Engine.Adapter do
  ...
  ## Ejemplo
      ...
      iex> Adapter.openai(messages, model, engine, routing_decision)
  """
  @spec openai(list(), Model.t(), Engine.t(), map()) :: {:ok, any()} | {:error, any()}
  def openai(messages, model, engine, routing_decision) do
  ...
  ## Ejemplo
      ...
      iex> Adapter.anthropic(messages, model, engine, routing_decision)
  """
  @spec anthropic(list(), Model.t(), Engine.t(), map()) :: {:ok, any()} | {:error, any()}
  def anthropic(messages, model, engine, routing_decision) do
  ...
  ## Ejemplo
      ...
      iex> Adapter.ollama(messages, model, engine, routing_decision)
  """
  @spec ollama(list(), Model.t(), Engine.t(), map()) :: {:ok, any()} | {:error, any()}
  def ollama(messages, model, engine, routing_decision) do
  ...
  ## Ejemplo
      ...
      iex> Adapter.llama_cpp(messages, model, engine, routing_decision)
  """
  @spec llama_cpp(list(), Model.t(), Engine.t(), map()) :: {:ok, any()} | {:error, any()}
  def llama_cpp(messages, model, engine, routing_decision) do
  ...
  ## Ejemplo
      ...
      iex> Adapter.stream_openai(messages, model, engine, routing_decision)
  """
  @spec stream_openai(list(), Model.t(), Engine.t(), map()) :: {:ok, any()} | {:error, any()}
  def stream_openai(messages, model, engine, routing_decision) do
  ...
  ## Ejemplo
      ...
      iex> Adapter.stream_anthropic(messages, model, engine, routing_decision)
  """
  @spec stream_anthropic(list(), Model.t(), Engine.t(), map()) :: {:ok, any()} | {:error, any()}
  def stream_anthropic(messages, model, engine, routing_decision) do
  ...
  ## Ejemplo
      ...
      iex> Adapter.stream_ollama(messages, model, engine, routing_decision)
  """
  @spec stream_ollama(list(), Model.t(), Engine.t(), map()) :: {:ok, any()} | {:error, any()}
  def stream_ollama(messages, model, engine, routing_decision) do
  ...
  ## Ejemplo
      ...
      iex> Adapter.stream_llama_cpp(messages, model, engine, routing_decision)
  """
  @spec stream_llama_cpp(list(), Model.t(), Engine.t(), map()) :: {:ok, any()} | {:error, any()}
  def stream_llama_cpp(messages, model, engine, routing_decision) do
